...
QGameControllerDisconnectEvent::QGameControllerDisconnectEvent(uint controllerId,bool connect): QGameControllerEvent(controllerId, *new QGameControllerDisconnectEventPrivate(this)) {
    Q_D(QGameControllerDisconnectEvent);
    d->connect=connect;
}
