...
struct  QGameControllerDisconnectEventPrivate : public QGameControllerEventPrivate
{
    Q_DECLARE_PUBLIC(QGameControllerDisconnectEvent)
public:
    QGameControllerDisconnectEventPrivate(QGameControllerEvent *q) : QGameControllerEventPrivate(q) { }
    bool connect;
};
