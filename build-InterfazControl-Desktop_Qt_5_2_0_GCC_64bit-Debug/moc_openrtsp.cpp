...
#include "../InterfazControl/openrtsp.h"
...
QT_MOC_LITERAL(4, 32, 13)
    ...
    "openRTSP\0isRecording\0\0saveVideo\0"
    "getVideoCount\0"
};
...
void openRTSP::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->isRecording((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->saveVideo(); break;
        case 2: { int _r = _t->getVideoCount();
        ...
        {
            typedef void (openRTSP::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&openRTSP::isRecording)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void openRTSP::isRecording(bool _t1)
{
